        ...
        <div class="main_content pd_030">
            <div class="clearfix">
                <form action="<%=request.getContextPath()%>/role/roleList" name="roleForm" id="roleForm" method="post">
                    <div class="clearfix">
                        <div class="index_search clearfix left">
                            <input type="search" placeholder="请输入用户名" class="left sch_input_search" name="roleName" value="${roleName}">
                ...
                <div class="operate_bar clearfix right ">
                    <a class="btns btn_new" href="<%=request.getContextPath()%>/role/add">新建角色</a>
                </div>
            </div>
                ...
                <table width="100%">
                    ...
                    <c:forEach var="role" varStatus="status" items="${pageView.records}">
                        <tr>
                            ...
                            <td>
                                <a class="btns reset_pwd btn_sml" href="<%=request.getContextPath()%>/role/edit?id=${role.fdId}">编辑</a>
                                <a class="btns reset_pwd btn_sml" href="#" onclick="del(${role.fdId})">删除</a>
                                <a class="btns reset_pwd btn_sml" href="<%=request.getContextPath()%>/permission/authorization?roleId=${role.fdId}">授权</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
