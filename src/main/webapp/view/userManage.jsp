    ...
    <div class="col_pageBar left">
        <div class="menu_box">            
            <dl class="menu">
                ...
                <dd class="menu_item menu_current"><a href="#">用户管理</a></dd>
        ...
        <div class="main_content pd_030">
            <div class="clearfix">
                ...
                <div class="operate_bar clearfix right ">
                    <a class="btns btn_new" href="#">新建用户</a>
                </div>
            </div>
                ...
                <table width="100%">
                    ...
                    <c:forEach var="user" varStatus="status" items="${pageView.records}">
                        <tr>
                            ...
                            <td>
                                <a class="btns reset_pwd btn_sml" href="#"
                                   onclick="delUser(${user.fdId})">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<div class="pop_content role_pop1 hide">
    ...
    <div class="pop_contents clearfix">        
        ...
        <div class="clearfix ">
            <span class="span_block"> 密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</span>
            <input placeholder="管理员" type="text" name="fdPassword">
        </div>
        <div class="clearfix mg_t_10">        
            <span class="span_block">角色</span>
            <select>
                <option>管理员权限</option>
                <option>评分权限</option>
            </select>
        ...
        <div class="clearfix mg_t_10">        
            ...
            <textarea placeholder="系统管理员，主要维护系统，以及相关人员信息的维护等"></textarea>            
        </div>
    </div>
...
<div class="pop_content role_pop1 ">
    <div class="title clearfix">
        <h3 class="left">新增用户信息</h3>
        <a href="javascript(0);" class="right pop_close"></a>
    </div>
    <form action="<%=request.getContextPath()%>/user/addUser" method="post" id="addUserForm">
    <div class="pop_contents clearfix">        
        <div class="clearfix ">        
            <span class="span_block"> 名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</span>
            <input placeholder="管理员" type="text" name = "fdUserName">
        </div>
        <div class="clearfix ">
            <span class="span_block"> 密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</span>
            <input placeholder="管理员" type="text" name = "fdPassword">
        ...
        <div class="clearfix mg_t_10">        
            <span class="span_block"> 角色</span>
            <select name="fdRoleName">
                <option value="0" selected="selected">--请选择--</option>
                <c:forEach var="role" items="${role.resultlist}">
                    <option value="${role.fdId}" name = "roleId">
                        ${role.fdRoleName}
                    </option>
                </c:forEach>
            </select>
